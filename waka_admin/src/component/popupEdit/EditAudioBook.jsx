            ...
            >
                <Box sx={style}>
                    ...
                    <Typography sx={{ mt: 2 }}>
                        <div className={cx('content-box')} style={{display: 'flex'}}>
                            <div style={{width: '160px', paddingTop: '15px', paddingLeft: '10px'}}>
                                <img src={props.dataEdit.coverAudioBook}  style={{ width: '100%', height: 'auto' }}></img>
                            </div>
                            <div className={cx('grid-container')}>
                                <div className={cx('grid-item')}>Book_name:</div>
                                <div className={cx('grid-item')}>
                                    <input value={props.dataEdit.audioBookName} readOnly></input>
                                </div>
                                <div className={cx('grid-item')}></div>
                                <div className={cx('grid-item')}>Book_category:</div>
                                <div className={cx('grid-item')}>
                                    <input value={props.dataEdit.audioBookCategory} readOnly></input>
                                </div>
                                <div className={cx('grid-item')}>Book_price:</div>
                                <div className={cx('grid-item')}>
                                    <input value={props.dataEdit.audioBookPrice} readOnly></input>
                                </div>
                                <div className={cx('grid-item')}></div>
                                <div className={cx('grid-item')}>Book_author:</div>
                                <div className={cx('grid-item')}>
                                    <input value={props.dataEdit.audioBookAuthor} readOnly></input>
                                </div>
                    ...
                    <Typography style={{paddingLeft: '3%', paddingRight: '3%'}}>
                        ...
                        <div className={cx('grid-item')}>
                            <textarea style={{ width: '100%', height: '100px' }} value={props.dataEdit.audioBookDescription}></textarea>
                        </div>
                    </Typography>
