 ...
 * </p>
 */
public final class ItemUserAverageRecommenderCustom extends AbstractRecommender {
  
  private static final Logger log = LoggerFactory.getLogger(ItemUserAverageRecommenderCustom.class);
  ...
  public ItemUserAverageRecommenderCustom(DataModel dataModel) throws TasteException {
    super(dataModel);
